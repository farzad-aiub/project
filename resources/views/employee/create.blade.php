                        ...
                        <form id="formAccountSettings" method="POST" action="{{route('employees.store')}}" >
                            ...
                            <div class="row">
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input class="form-control" type="text" id="firstName" name="firstName" placeholder="John" autofocus />
                                </div>
                                <div class="mb-3 col-md-6">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input class="form-control" type="text" id="email" name="email" placeholder="john.doe@example.com" placeholder="john.doe@example.com" />
                                </div>
                                <div class="mb-3 col-md-6">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="text" id="phoneNumber" name="phoneNumber" class="form-control" placeholder="01*******" />
                                    </div>
                                </div>
                                <div class="mb-3 col-md-6">
